    ...
    <div className="min-h-screen flex items-center justify-center bg-warm-white p-4">
      <div className="flex flex-col gap-6 rounded-[24px] bg-white p-8 max-w-md w-full shadow-xl">
        <div className="text-center">
          ...
          <p className="text-sm text-mid-gray mt-1">Peer-to-peer video streaming with WebRTC</p>
        </div>
        ...
        <label className="w-full">
          ...
          />
          <div className="mt-2">
            <span className="text-xs text-light-gray">Share this ID with other devices</span>
          </div>
        </label>
        ...
        <div className="grid grid-cols-1 gap-4">
          <button
            ...
            <span className="px-3 py-1 text-xs bg-coral-dark rounded-full">Camera</span>
          </button>
          ...
          <button
            ...
            <span className="px-3 py-1 text-xs bg-soft-blue/60 rounded-full">Viewer</span>
          </button>
        </div>
