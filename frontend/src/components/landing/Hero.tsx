    ...
    <section className="relative min-h-screen overflow-hidden pt-28 pb-16">
      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-[1.1fr,0.95fr] gap-14 items-center relative z-10">
        ...
        <div className="flex flex-col gap-6">
          ...
          >
            Soft gradients, rounded edges, and calm motion — the interface feels as cozy as
            holding your baby. Monitor live video, talk back with warmth, and get gentle
            alerts built on WebRTC + Firebase.
          </motion.p>
          ...
          <motion.div {...textMotion} transition={{ delay: 0.45, duration: 0.45 }} className="flex items-center gap-4 mt-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-mid-gray font-semibold">
                1k+ families feel safer with BabyWatcher
              </span>
            </div>
          </motion.div>
        </div>
              ...
              <div className="grid grid-cols-3 gap-3 mt-4">
                {[
                  ...
                  >
                    ...
                    <span className="text-[11px] font-semibold text-charcoal/80 text-center">
                      {item.label}
                    </span>
                  </motion.div>
                ))}
