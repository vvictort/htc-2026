        ...
        <motion.div
          ...
          <div className="relative z-10 max-w-2xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a
                href="#features"
                className="btn no-underline text-base px-10 py-4 rounded-[30px] border border-white/20 text-white hover:border-coral hover:text-coral hover:bg-white/5 transition-colors">
                See Features
              </a>
            </div>
          </div>
