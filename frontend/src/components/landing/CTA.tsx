        ...
        <motion.div
          ...
          <div className="relative z-10 max-w-2xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link to="/monitor" onClick={handleStartFree} className="btn-primary no-underline text-base px-10 py-4">
                Start Free Today
              </Link>
              <a
                href="/#features"
                className="no-underline text-base px-10 py-4 rounded-full border border-white/20 text-white hover:border-coral hover:text-coral transition-all">
                See Features
              </a>
            </div>
          </div>
