    ...
    return (
        ...
        >
            <div className="bg-white/80 backdrop-blur-xl rounded-[var(--radius-card)] border border-white/60 shadow-[0_12px_40px_rgba(31,29,43,0.12)] p-8">
                <h2 className="text-3xl font-extrabold text-charcoal mb-2 text-center">
                    Welcome Back
                </h2>
                <p className="text-mid-gray text-center mb-6">
                    Log in to your BabyWatcher account
                </p>
                ...
                {apiError && (
                    ...
                    >
                        ...
                        {apiHelp && (
                            <p className="text-xs text-mid-gray mt-1">{apiHelp}</p>
                        )}
                    </motion.div>
                )}
                ...
                <form onSubmit={handleSubmit} noValidate>
                    ...
                    <div className="mb-4">
                        ...
                        />
                        {errors.password && (
                            <p className="text-xs text-coral mt-1">{errors.password}</p>
                        )}
                    </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                    <button
                        type="button"
                        disabled
                        className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg border border-warm-cream bg-white/50 text-charcoal hover:bg-warm-cream/60 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                    >
